...
const LandingPage = ({ onAction }) => {
  const actions = [
    { id: 'victim', label: '[ INITIATE_BEACON_UPLINK ]', style: LandingStyles.btnPrimary },
    { id: 'split', label: '[ LAUNCH_LINKED_RELAY_DEMO ]', style: LandingStyles.btnSecondary },
    { id: 'dashboard', label: '[ ACCESS_MISSION_CONTROL ]', style: LandingStyles.btnSecondary },
  ];
...
const LandingStyles = {
  ...
  actionGrid: { display: 'flex', gap: 24, flexWrap: 'wrap', justifyContent: 'center' },
